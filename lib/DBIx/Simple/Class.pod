...
Class method. 
This is your real class builder. It is called in L</new> and 
L</new_from_dbix_simple> only once before L<bless>. It creates your accessors 
and does other things if needed. You can inject your logic here if you 
overridethis method. In your C<BUILD> do not forget to call 
